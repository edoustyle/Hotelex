function MultiSelectTag(e,t={shadow:!1,rounded:!0}){
    var n=null,
    l=null,d=null,a=null,s=null,i=null,o=null,r=null,c=null,u=null,p=null,v=null,m=t.tagColor||{},
    h=new DOMParser;
    ...
    function f(e=null){
        ...
        function g(e){
            ...
            t.style.color=m.textColor||"#ffffff",
            t.style.borderColor=m.borderColor||"#000000",
            t.style.background=m.bgColor||"#39371F";
            const n=document.createElement("div");
            n.classList.add("item-label"),
            n.style.color=m.textColor||"#ffffff",
            n.innerHTML=e.label,
            n.dataset.value=e.value;
            const d=(new DOMParser).parseFromString('<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="item-close-svg">\n                <line x1="18" y1="6" x2="6" y2="18"></line>\n                <line x1="6" y1="6" x2="18" y2="18"></line>\n                </svg>',"image/svg+xml").documentElement;
            d.addEventListener("click",(t=>{l.find((t=>t.value==e.value)).selected=!1,C(e.value),f(),E()})),
            t.appendChild(n),t.appendChild(d),o.append(t)
        }
        function L(){
            for(var e of v.children)e.addEventListener("click",(e=>{
                l.find((t=>t.value==e.target.dataset.value)).selected=!0,
                c.value=null,f(),E(),c.focus()}))
        }
        function w(e){
        ...
        function(){
            ...
            p.append(r),v=document.createElement("ul"),
            p.appendChild(v),d.appendChild(a),
            d.appendChild(p),n.nextSibling?n.parentNode.insertBefore(d,n.nextSibling):n.parentNode.appendChild(d)
        }
        (),f(),L(),E(!1),
        u.addEventListener("click",(()=>{p.classList.contains("hidden")&&(f(),L(),p.classList.remove("hidden"),c.focus())})),
        c.addEventListener("keyup",(e=>{f(e.target.value),L()})),
        c.addEventListener("keydown",(e=>{
            if("Backspace"===e.key&&!e.target.value&&o.childElementCount>1){
                ...
                C(e.dataset.value),E()}})),
                window.addEventListener("click",(e=>{d.contains(e.target)||p.classList.add("hidden")}))
}